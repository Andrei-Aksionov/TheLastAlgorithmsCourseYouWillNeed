...
@pytest.mark.array
def test_array_list_all_combined() -> None:
...
def test_array_list_capacity(numbers: List[int], capacity: int) -> None:
    # Given
...
def test_array_list_growth_value(numbers: List[int], growth_value: int) -> None:
    # Given
...
def test_array_list_capacity_and_growth_value(numbers: List[int], capacity: int, growth_value: int) -> None:
    # Given
...
def test_array_list_append(numbers: List[int]) -> None:
    # Given
    array_list = ArrayList(capacity=3, growth_value=3)
...
def test_array_list_get(numbers: List[int], get_at: int) -> None:
    # Given
    array_list = ArrayList(capacity=3, growth_value=3)
...
def test_array_list_remove_at(numbers: List[int], remove_at: int) -> None:
    # Given
    array_list = ArrayList(capacity=3, growth_value=3)
...
def test_array_list_prepand(numbers: List[int], prepand_number: int) -> None:
    # Given
    array_list = ArrayList(capacity=3, growth_value=3)
...
@pytest.mark.array
@pytest.mark.parametrize("numbers", [random.sample(range(-100, 100), random.randint(1, 25)) for _ in range(10)])
def test_array_list_prepand_to_empty(numbers: List[int]) -> None:
    # Given
    array_list = ArrayList(capacity=3, growth_value=3)
